...
<div class='mf-form-group mf-form-group-<?php echo esc_attr($id) ?>'>
    ...
    <div class="mf-input-container">
        ...
        <?php if ($payload->optionsDisplay != "inline") :
            ...
            <div class="mf-custom-control mf-custom-control-inline mf-custom-radio">
                <input type="radio"  <?php echo esc_attr($disabled); ?> name="<?php echo esc_attr($id) ?>_value" value="other" class="mf-custom-control-input <?php echo esc_html(implode(" ", $payload->cssClasses)) ?>" id="<?php echo esc_attr($id) ?>_other"/>
                <label class="mf-custom-control-label" for="<?php echo esc_attr($item->id); ?>_other"><?php echo esc_html($payload->otherLabel) ?></label>
