<select class="mf-phone-element mf-form-control <?php echo ($payload->disabled) ? "disabled" : "" ?>  <?php echo esc_attr($fieldSizes[$payload->fieldSize]) ?>  <?php echo esc_attr($fieldWidths[$payload->fieldWidth]); ?>  <?php echo esc_attr(implode(" ", $payload->cssClasses)) ?>" name="<?php echo esc_attr($id) ?>_phoneCode">
<option value=""><?php esc_html_e("Please Select","magicform"); ?></option>
    <option name="AF" value="93">Afghanistan (+93)</option>
    <option name="AX" value="358">Åland Islands(+358)</option>
    <option name="AL" value="355">Albania (+355)</option>
    <option name="DZ" value="213">Algeria (+213)</option>
    <option name="AS" value="684">American Samoa(+684)</option>
    ...
    <option name="AQ" value="672">Antarctica (+672)</option>
    ...
    <option name="BQ" value="599">Bonaire, Sint Eustatius and Saba(+599)</option>
    ...
    <option name="IO" value="246">British Indian Ocean Territory</option>
    <option name="VG" value="1284">British Virgin Islands</option>
    <option name="BN" value="673">Brunei Darussalam(+673)</option>
    ...
    <option name="TD" value="235">Chad (+235)</option>
    <option name="CL" value="56">Chile (+56)</option>
    <option name="CN" value="86">China (+86)</option>
    <option name="CX" value="61">Christmas Island (+61)</option>
    <option name="CC" value="61">Cocos (Keeling) Islands (+61)</option>
    ...
    <option name="CI" value="506">Côte d'Ivoire (+225)</option>
    ...
    <option name="CZ" value="42">Czech Republic (+420)</option>
    <option name="DK" value="45">Denmark (+45)</option>
    <option name="DJ" value="253">Djibouti (+253)</option>
    <option name="DM" value="1809">Dominica (+1767)</option>
    ...
    <option name="FM" value="691">Federated States of Micronesia (+691)</option>
    ...
    <option name="GE" value="995">Georgia (+995)</option>
    ...
    <option name="MU" value="230">Mauritius (+230)</option>
    ...
    <option name="ME" value="382">Montenegro (+382)</option>
    ...
    <option name="AN" value="31">Netherlands Antilles (+599)</option>
    ...
    <option name="NP" value="1670">Northern Mariana Islands(+1670)</option>
    <option name="NO" value="47">Norway (+47)</option>
    <option name="OM" value="968">Oman (+968)</option>
    <option name="PK" value="968">Pakistan (+92)</option>
    <option name="PW" value="680">Palau (+680)</option>
    <option name="PS" value="970">Palestine</option>
    ...
    <option name="PN" value="64">Pitcairn</option>
    ...
    <option name="BL" value="290">Saint Barthélemy (+590)</option>
    <option name="SH" value="290">Saint Helena (+290)</option>
    <option name="KN" value="1869">Saint Kitts and Nevis(+1869)</option>
    <option name="LC" value="1758">Saint Lucia (+1758)</option>
    <option name="MF" value="590">Saint Martin (+590)</option>
    <option name="PM" value="508">Saint Pierre and Miquelon (+508)</option>
    <option name="VC" value="1784">Saint Vincent and The Grenadines (+1784)</option>
    <option name="WS" value="685">Samoa (+685)</option>
    <option name="SM" value="378">San Marino (+378)</option>
    <option name="ST" value="239">Sao Tome and Principe (+239)</option>
    ...
    <option name="SX" value="1721">Sint Maarten (+1721)</option>
    ...
    <option name="SS" value="211">South Sudan (+211)</option>
    ...
    <option name="SJ" value="47">Svalbard and Jan Mayen (+47)</option>
    ...
    <option nane="TZ" value="255">Tanzania(+255)</option>
    <option name="TH" value="66">Thailand (+66)</option>
    <option name="TL" value="66">Timor-Leste (+670)</option>
    <option name="TG" value="228">Togo (+228)</option>
    <option name="TK" value="690">Tokelau (+690)</option>
    <option name="TO" value="676">Tonga (+676)</option>
    <option name="TT" value="1868">Trinidad and Tobago (+1868)</option>
    ...
    <option name="TC" value="1649">Turks and Caicos Islands (+1649)</option>
    ...
    <option name="GB" value="44">United Kingdom (+44)</option>
    <option name="US" value="1">United States of America (+1)</option>
    <option name="UY" value="598">Uruguay (+598)</option>
    <option name="VI" value="1340">U.S. Virgin Islands (+1340)</option>
    ...
    <option name="EH" value="212">Western Sahara (+212)</option>
